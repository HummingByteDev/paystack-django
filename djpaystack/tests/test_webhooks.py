...
class TestWebhookHandler(TestCase):
    ...
    def test_event_handling(self):
        ...
        data = {
            ...
            "currency": "NGN",
            "status": "success",
            "customer": {"email": "test@example.com", "customer_code": "CUS_xxxxx"},
            "authorization": {"authorization_code": "AUTH_xxxxx"},
            "channel": "card",
            "fees": 750,
        ...
        with patch("djpaystack.webhooks.handlers.paystack_settings") as mock_settings:
            ...
            result = self.handler.handle_event(WebhookEvent.CHARGE_SUCCESS, data)
...
class TestWebhookView(TestCase):
    ...
    def test_valid_webhook_request(self):
        ...
        payload = {"event": "charge.success", "data": mock_transaction_data}
