...
class PaystackTransactionAdmin(admin.ModelAdmin):
    list_display = ["reference", "customer_email", "amount", "currency", "status", "created_at"]
...
class PaystackCustomerAdmin(admin.ModelAdmin):
    list_display = ["email", "customer_code", "first_name", "last_name", "created_at"]
    search_fields = ["email", "customer_code", "first_name", "last_name"]
    readonly_fields = ["customer_code", "created_at", "updated_at", "raw_response"]
    date_hierarchy = "created_at"
...
class PaystackSubscriptionAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["subscription_code", "created_at", "updated_at", "raw_response"]
    date_hierarchy = "created_at"
...
class PaystackTransferAdmin(admin.ModelAdmin):
    list_display = ["transfer_code", "reference", "amount", "currency", "status", "created_at"]
    list_filter = ["status", "currency", "created_at"]
    search_fields = ["transfer_code", "reference", "recipient_code"]
    readonly_fields = ["transfer_code", "created_at", "updated_at", "raw_response"]
    date_hierarchy = "created_at"
