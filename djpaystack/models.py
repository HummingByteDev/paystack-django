...
class PaystackCustomer(PaystackBaseModel):
    ...
    customer_code = models.CharField(max_length=255, unique=True, db_index=True)
...
class PaystackSubscription(PaystackBaseModel):
    ...
    subscription_code = models.CharField(max_length=255, unique=True, db_index=True)
...
class PaystackTransfer(PaystackBaseModel):
    ...
    transfer_code = models.CharField(max_length=255, unique=True, db_index=True)
    reference = models.CharField(max_length=255, unique=True, db_index=True)
