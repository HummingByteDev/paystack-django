...
class WebhookTester:
    ...
    def _generate_signature(self, payload: bytes) -> str:
        ...
        return hmac.new(self.webhook_secret.encode("utf-8"), payload, hashlib.sha512).hexdigest()

    def send_event(
        self, event_type: str, data: Dict[str, Any], headers: Optional[Dict[str, str]] = None
    ) -> requests.Response:
        """
        ...
        response = requests.post(self.webhook_url, data=payload_bytes, headers=request_headers)
    ...
    def send_charge_success(
        ...
        **kwargs,
        ...
        data = {
            ...
            "customer": {"email": email, "customer_code": "CUS_test123"},
            "authorization": {
    ...
    def send_charge_failed(
        self, reference: str = "test_ref_456", amount: int = 50000, email: str = "test@example.com"
    ) -> requests.Response:
    ...
    def send_subscription_create(
        self, subscription_code: str = "SUB_test123", email: str = "test@example.com"
    ) -> requests.Response:
        ...
        data = {
            ...
            "status": "active",
            "customer": {"email": email, "customer_code": "CUS_test123"},
            "plan": {"plan_code": "PLN_test123", "name": "Premium Plan", "interval": "monthly"},
    ...
    def send_transfer_success(
        self, transfer_code: str = "TRF_test123", amount: int = 100000
    ) -> requests.Response:
